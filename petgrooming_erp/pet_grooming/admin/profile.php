...
$target_dir = "../assets/uploadImage/Profile/";
  ...
  $sql = "UPDATE tbl_admin SET fname=:fname,lname=:lname, email=:email,username=:username,gender=:gender, dob=:dob,contact=:contact, address=:address,image=:website_logo WHERE id='".$_SESSION['id']."'";
