...
<body style="background-image: url('assets/uploadImage/Logo/<?php echo$background_login_image; ?>');">
    <!-- ============================================================== -->
    <!-- login page  -->
    <!-- ============================================================== -->
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="../index.php"><img class="img-fluid" src="assets/uploadImage/Logo/<?php echo$logo; ?>" style="width:50%;height:5%;" alt="Theme-Logo" width="50%" />
                         </a><span class="splash-description" width="50%">Voter Login.</span></div>
            <div class="card-body">
