...
<head>
      ...
      <link rel="icon" type="image/x-icon" href="assets/uploadImage/Logo/<?php echo $row['favicon'];?>">
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body style="
  background: 
    ...
    url('assets/uploadImage/Logo/backimg.png');
...
">
    ...
    <div class="splash-container">
        <div class="card login-page-form shadow-none">
            <div class="card-header  text-center border-bottom-0"><a href="../index.php"><img class="img-fluid" src="assets/uploadImage/Logo/<?php echo $logo; ?>" style="width:300px;height:auto;" alt="Theme-Logo" width="50%" />
